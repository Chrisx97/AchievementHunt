...
public class KillSkeletonWithBoneGoal extends KillGoal
{
    ...
    public ItemStack GetDisplayItem()
    {
        if (myItem == null)
        {
            myItem = ItemUtil.Instance.CreateGuiItem(Material.SKELETON_SKULL, GetName(), false, null, GetDescription());
        }
        if (isCompleted) {
            myItem = ItemUtil.Instance.CreateGuiItem(Material.SKELETON_SKULL, GetName(), true, whoClaimedGoal, GetDescription());
        }
        return myItem;
    }
