...
public class MineIronOreGoal extends BlockCollectGoal
{
    ...
    public ItemStack GetDisplayItem()
    {
        if (myItem == null)
        {
            myItem = ItemUtil.Instance.CreateGuiItem(Material.IRON_ORE, GetName(), false, null, GetDescription());
        }
        if (isCompleted) {
            myItem = ItemUtil.Instance.CreateGuiItem(Material.IRON_ORE, GetName(), true, whoClaimedGoal, GetDescription());
        }
        return myItem;
    }
