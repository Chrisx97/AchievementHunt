...
public class MineDiamondOreGoal extends BlockCollectGoal
{
    ...
    public ItemStack GetDisplayItem()
    {
        if (myItem == null)
        {
            myItem = ItemUtil.Instance.CreateGuiItem(Material.DIAMOND_ORE, GetName(), false, null, GetDescription());
        }
        if (isCompleted) {
            myItem = ItemUtil.Instance.CreateGuiItem(Material.DIAMOND_ORE, GetName(), true, whoClaimedGoal, GetDescription());
        }
        return myItem;
    }
    ...
    public List<String> GetDescription()
    {
        ...
        description.add("&7Awarded when the player breaks &bDiamond Ore&7.");
        return description;
    }
