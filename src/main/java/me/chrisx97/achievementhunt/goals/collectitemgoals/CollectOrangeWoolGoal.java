...
public class CollectOrangeWoolGoal extends CollectItemGoal
{
    ...
    public ItemStack GetDisplayItem()
    {
        if (myItem == null)
        {
            myItem = ItemUtil.Instance.CreateGuiItem(Material.ORANGE_WOOL, GetName(), false, null, GetDescription());
        }
        if (isCompleted) {
            myItem = ItemUtil.Instance.CreateGuiItem(Material.ORANGE_WOOL, GetName(), true, whoClaimedGoal, GetDescription());
        }
    ...
    public List<String> GetDescription()
    {
        ...
        description.add("&fOrange Wool&7.");
        return description;
    }
    ...
    {
        if (itemType == Material.ORANGE_WOOL)
        {
            return true;
        }
