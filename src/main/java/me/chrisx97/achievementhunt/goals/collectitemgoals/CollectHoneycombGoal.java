...
public class CollectHoneycombGoal extends CollectItemGoal
{
    ...
    public ItemStack GetDisplayItem()
    {
        if (myItem == null)
        {
            myItem = ItemUtil.Instance.CreateGuiItem(Material.HONEYCOMB, GetName(), false, null, GetDescription());
        }
        if (isCompleted) {
            myItem = ItemUtil.Instance.CreateGuiItem(Material.HONEYCOMB, GetName(), true, whoClaimedGoal, GetDescription());
        }
