...
public class CollectStainedGlassBlueGoal extends CollectItemGoal
{
    ...
    public ItemStack GetDisplayItem()
    {
        if (myItem == null)
        {
            myItem = ItemUtil.Instance.CreateGuiItem(Material.BLUE_STAINED_GLASS, GetName(), false, null, GetDescription());
        }
        if (isCompleted) {
            myItem = ItemUtil.Instance.CreateGuiItem(Material.BLUE_STAINED_GLASS, GetName(), true, whoClaimedGoal, GetDescription());
        }
    ...
    {
        return "Obtain Blue Stained Glass";
    }
    ...
    public List<String> GetDescription()
    {
        ...
        description.add("&fBlue Stained Glass&7.");
        return description;
    }
    ...
    {
        if (itemType == Material.BLUE_STAINED_GLASS)
        {
            return true;
        }
