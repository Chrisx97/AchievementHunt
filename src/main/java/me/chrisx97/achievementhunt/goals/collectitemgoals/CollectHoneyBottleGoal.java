...
public class CollectHoneyBottleGoal extends CollectItemGoal
{
    ...
    public ItemStack GetDisplayItem()
    {
        if (myItem == null)
        {
            myItem = ItemUtil.Instance.CreateGuiItem(Material.HONEY_BOTTLE, GetName(), false, null, GetDescription());
        }
        if (isCompleted) {
            myItem = ItemUtil.Instance.CreateGuiItem(Material.HONEY_BOTTLE, GetName(), true, whoClaimedGoal, GetDescription());
        }
    ...
    public List<String> GetDescription()
    {
        ...
        description.add("&6Honey Bottle&7.");
        return description;
    }
