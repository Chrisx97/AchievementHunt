...
public class CollectStainedGlassLimeGoal extends CollectItemGoal
{
    ...
    public ItemStack GetDisplayItem()
    {
        if (myItem == null)
        {
            myItem = ItemUtil.Instance.CreateGuiItem(Material.LIME_STAINED_GLASS, GetName(), false, null, GetDescription());
        }
        if (isCompleted) {
            myItem = ItemUtil.Instance.CreateGuiItem(Material.LIME_STAINED_GLASS, GetName(), true, whoClaimedGoal, GetDescription());
        }
    ...
    {
        return "Obtain Lime Stained Glass";
    }
    ...
    public List<String> GetDescription()
    {
        ...
        description.add("&fLime Stained Glass&7.");
        return description;
    }
    ...
    {
        if (itemType == Material.LIME_STAINED_GLASS)
        {
            return true;
        }
